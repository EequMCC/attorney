...
class MyWin(QWidget):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("lawyer.png"))
    ...
    def setup_Ui(self):
        ...
        self.setting_win.setWindowIcon(QIcon("lawyer.png"))
        ...
        self.setting_layout.itemAt(1,1).widget().addAction(QAction(QIcon("more.png"),"",self),QLineEdit.TrailingPosition)
        self.setting_layout.itemAt(2,1).widget().addAction(QAction(QIcon("more.png"),"",self),QLineEdit.TrailingPosition)
        ...
        self.task_button.setIcon(QIcon("tasks.png"))
        self.law_button.setIcon(QIcon("book.png"))
        self.allcase_button.setIcon(QIcon("paper.png"))
        self.collect_button.setIcon(QIcon("star.png"))
        self.files_button.setIcon(QIcon("folder.png"))
        self.newlaw_button.setIcon(QIcon("book_new.png"))
        ...
        last_page.setIcon(QIcon("last.png"))
        ...
        next_page.setIcon(QIcon("next.png"))
        ...
        action = QAction(self)
        action.setIcon(QIcon("add_ok.png"))
        ...
        self.record.setIcon(QIcon("add_case_ok.png"))
        ...
        self.make_paper.setIcon(QIcon("notes.png"))
        ...
        self.more_inf_win.setWindowIcon(QIcon("lawyer.png"))
